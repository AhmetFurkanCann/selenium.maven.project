...
public class CheckAllButtonControl {
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread.sleep(2000);
        Assert.assertEquals(isAllCheckBoxesSelected(driver), true);
        driver.close();

    }

    private static boolean isAllCheckBoxesSelected(WebDriver driver) {
        //Fill the array with checkBoxElements
        List<WebElement> checkBoxArray = driver.findElements(By.xpath("//input[@type='checkbox']"));
        //Loop for Checking isAllCheckBoxesSelected

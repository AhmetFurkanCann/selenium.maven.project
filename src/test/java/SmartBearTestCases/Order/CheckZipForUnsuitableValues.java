...
public class CheckZipForUnsuitableValues {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] testValuesNotPossible = {"abc", "*/", "a12", " jalskfhaklf", "12a", "-12"};
    ...
    private static void testMethodForUnSuitableValues(String[] testValuesNotPossible, WebDriver driver) throws InterruptedException {
        ...
        for (int i = 0; i < testValuesNotPossible.length; i++) {
            ...
            driver.findElement(By.xpath("/html/body/form/table/tbody/tr/td[2]/div[2]/table/tbody/tr/td/ol[2]/li[5]/input")).sendKeys(testValuesNotPossible[i]);
            driver.findElement(By.xpath("/html/body/form/table/tbody/tr/td[2]/div[2]/table/tbody/tr/td/div/a")).click();
            Thread.sleep(2000);
            try {
                Assert.assertEquals(driver.findElement(By.xpath("/html/body/form/table/tbody/tr/td[2]/div[2]/table/tbody/tr/td/ol[2]/li[5]/span[2]")).getText(), "Invalid format. Only digits allowed.");
